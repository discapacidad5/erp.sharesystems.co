	...
	<body class="desktop-detected pace-done hidden-menu">
		...
		<header id="header" class="navbar navbar-default navbar-fixed-top" style="height: 70px">
			<div id="logo-group">
				...
				<span id="logo"> <a href="/ov/dashboard"><img style="width: 10rem; height: auto;" src="http://sharesystems.co/wp-content/themes/netsoftuno/images/logo.png" alt="Networksoft"> </a></span>
